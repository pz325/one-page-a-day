            ...
            'exercies': [
                {
                    ...
                    'exercises': [
                        r'Use an expression to express the length of the road section: $\rule{2cm}{0.15mm}$',
                    ]
                },
                {
                    'description': r'Simplify first and then evaluate.',
                    'exercises': [
                        r'When $m=4$ and $n=1.8$, find the value of $15m+5m-18n-12n$. $\rule{2cm}{0.15mm}$',
                    ]
                },
                {
                    'description': r'A farm has cultivated sycamores and cedars. They are each in $x$ rows. Sycamores are in rows of 12 and cedars are in rows of 14 across.',
                    'exercises': [
                        r'How many sycamores and cedars has the farm clutivated in total?',
                        r'When $x=20$, how many sycamores and cedars are there on the farm?'
                    ]
                },
                {
            ...
            'exercies': [
                {
                    ...
                    'exercises': [
                        r'An expression with variables is an equation.',
                        r'$9-3x$ is not an equation.'
                    ]
                },
            ]
        },  # a section object
            ...
            'exercies': [
                {
                    ...
                    'exercises': [
                        r'Establish an equation with $x$ and $y$',
                        r'List all the possible combinations of $x$ and $y$ that satisfy the equation. (Note: $x$ and $y$ must be positive numbers)'
                    ]
                },
                r'A department store received 324 pairs of sports shoes packed in boxes of the same size. If 2 boxes contain 72 pairs of shoes, how many boxes did the store received?'
            ]
        },  # a section object
        {
            ...
            'exercies': [
                {
                    ...
                    'exercises': [
                        r'The sum of 4 times $x$ and 3.2 is 9.8. Find $x$.',
                    ]
                },
                r'Solve the equation: $7.8-x\div3=2.2$',
            ]
        },  # a section object
        {
            ...
            'exercies': [
                {
                    ...
                    'exercises': [
                        r'The area of a rectangle is 36 cm\textsuperscript{2} . The length is 8 cm. What is the width of the rectangle?',
                    ]
                },
                r'Julie bought 1 bath towel and 4 hand towels for \pounds20. Given that the price of the bath towel was \pounds6, how much did each hand towel cost?'
            ]
        },  # a section object
    ]
}  # a book object
